...
exports.STYLE_DIR = exports.SRC_DIR = exports.getQuickConfig = exports.getPackageJson = exports.STYLE_EXTS = exports.SCRIPT_EXTS = exports.JEST_STYLE_MOCK_FILE = exports.JEST_FILE_MOCK_FILE = exports.JEST_TRANSFORM_FILE = exports.JEST_CONFIG_FILE = exports.JEST_SETUP_FILE = exports.POSTCSS_CONFIG_FILE = exports.BABEL_CONFIG_FILE = exports.STYPE_DEPS_JSON_FILE = exports.SITE_DESKTOP_SHARED_FILE = exports.SITE_MODILE_SHARED_FILE = exports.PACKAGE_STYLE_FILE = exports.PACKAGE_ENTRY_FILE = exports.CONFIG_DIR = exports.DIST_DIR = exports.CACHE_DIR = exports.ROOT_POSTCSS_CONFIG_FILE = exports.ROOT_WEBPACK_CONFIG_FILE = exports.PACKAGE_JSON_FILE = exports.QUICK_CONFIG_FILE = exports.SITE_DIST_DIR = exports.VETUR_DIR = exports.DOCS_DIR = exports.LIB_DIR = exports.ES_DIR = exports.ROOT = exports.CWD = exports.GREEN = void 0;
const lodash_1 = require("lodash");
const fs_extra_1 = require("fs-extra");
const path_1 = require("path");
function findRootDir(dir) {
    if (fs_extra_1.existsSync(path_1.join(dir, 'quick.config.js'))) {
        return dir;
    }
...
exports.QUICK_CONFIG_FILE = path_1.join(exports.ROOT, 'quick.config.js');
...
function getQuickConfig() {
    delete require.cache[exports.QUICK_CONFIG_FILE];
    try {
        return require(exports.QUICK_CONFIG_FILE);
    }
    catch (err) {
        return {};
    }
}
exports.getQuickConfig = getQuickConfig;
function getSrcDir() {
    const quickConfig = getQuickConfig();
    const srcDir = lodash_1.get(quickConfig, 'build.srcDir');
    if (srcDir) {
