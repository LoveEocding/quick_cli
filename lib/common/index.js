...
function getWebpackConfig(defaultConfig) {
    if (fs_extra_1.existsSync(constant_1.ROOT_WEBPACK_CONFIG_FILE)) {
        ...
        if (typeof config === 'function') {
            return webpack_merge_1.default(defaultConfig, config(defaultConfig));
        }
